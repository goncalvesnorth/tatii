...
function zee_style_options(){
    ...
    if( zee_option('zee_body_text_font','face') ){ 
        ...
        echo '@import url(https://fonts.googleapis.com/css?family='. str_replace(' ','+',zee_option('zee_body_text_font','face')) .':400,100,100italic,300,300italic,400italic,500,500italic,700,700italic,900,900italic);';

    } else {
        echo '@import url(https://fonts.googleapis.com/css?family=Roboto:400,100,100italic,300,300italic,400italic,500,500italic,700,700italic,900,900italic);
        ';
    }
    ...
    if( zee_option('zee_heading_font','face') and ( zee_option('zee_body_text_font','face')!=zee_option('zee_heading_font','face') ) ){  
        ...
        echo "\n" . '@import url(https://fonts.googleapis.com/css?family='.str_replace(' ','+',zee_option('zee_heading_font','face')).':400,100,100italic,300,300italic,400italic,500,500italic,700,700italic,900,900italic);';
    }
    ?>
