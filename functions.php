...
function shapeSpace_display_popular_posts($atts) {
    ...
    <h3 style="padding-top: 30px;padding-bottom: 0px; margin-bottom: 0;">Posts mais populares</h3>
    <div class="row text-center">
        ...
        <div class="col-lg-12 col-md-4 col-12 popular-posts"><a href="<?php the_permalink(); ?>"><?php the_post_thumbnail(); ?><?php the_title(); ?></a></div>
...
wp_enqueue_script('disqus_count','https://'.$disqus_shortname.'.disqus.com/count.js');
...
function zee_post_nav() {
    ...
    <div class="row" role="navigation">
            ...
            <div class="col-lg-6">
                <div class="pull-left">
                    <?php previous_post_link( '%link', _x( '<span class="lnr lnr-pointer-left"> </span> Post anterior', 'Previous post link', ZEETEXTDOMAIN ) ); ?>
                </div>
            </div>
            <?php } ?>
            ...
            <div class="col-lg-6">
                <div class="pull-right">
                    <?php next_post_link( '%link', _x( 'Próximo post <span class="lnr lnr-pointer-right"></span>', 'Next post link', ZEETEXTDOMAIN ) ); ?>
                </div>
            </div>
            <?php } ?>
...
register_sidebar(array(
  ...
  'before_title' => '<h3>',
  'after_title' => '</h3>',
  'before_widget' => '<div class="widgets_tatii">',
  'after_widget' => '</div>'
  )
);
